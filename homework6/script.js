...
// იგივეს ვერ ვიტყვით ფუნცქიის ექსფრეშენებზე (მაგ: arrow function), იმ შემთხვევაში თუ ფუნქციის ექსფრეშენის გამოძახებას ვეცდებით მის
// ინიციალიზაციამდე მივიღებთ ერორს, რადგან ამ დროს ფუნქციის შენახვა ხდება ცვლადში (let, const, var).
// let და const "ჰოისტდება" დეფოლტ ინიციალიზაციის გარეშე, შესაბამისად ვიღებთ ერორს: Cannot access 'sumNumbers' before initialization, 
// ხოლო თუ ფუნქციას შევინახავთ var ცვალდში, რომელიც "ჰოისტდება" დეფოლტ ინიციალიზაციით: "undefined", მივიღებთ ერორს: 
// TypeError: sumNumbers is not a function, რადგან მისი ფუნქციად გამოძახება შეუძლებელია.
